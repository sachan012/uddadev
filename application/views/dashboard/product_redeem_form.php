                     ...
                     <div class="row bg-white border mx-0 mt-2 table2">
                        ...
                        <div class="col-12 my-4 text-right">                                  
                            ...
                            <?php if(empty($address_line1)){?>
                                <button type="submit" id="UpdateDetails" class="redeembtn btn btn-info text-white py-1 rounded-0 px-4" value="Update Details">Update Details</button>
                            <?php }else{?>
                                <button type="submit" id="continueBtn" class="redeembtn btn btn-info text-white py-1 rounded-0 px-4" value="Continue">Continue</button>
                            <?php }?>					
                        </div> 
